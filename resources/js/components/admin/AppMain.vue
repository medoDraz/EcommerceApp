...
<!--                                <img style="height: 35px;" src="{{auth()->user()->image_path}}" alt="avatar"><i></i>-->
                            ...
                            <!--                                </li>-->
                            <!--                                &lt;!&ndash;                            {{                           <li class="scrollable-container media-list w-100"> &ndash;&gt;-->
            ...
            <div class="main-menu-content">
                <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                    <li class="nav-item @if(Route::current()->getName() == 'admin.welcome') active @endif"><a
                        href=""><i class="la la-home"></i><span
                    ...
                    <!--                            </li>-->
                    <!--                            &lt;!&ndash;                        @if (auth()->user()->hasPermission('users_create'))&ndash;&gt;-->
                    ...
                    <li class="nav-item @if(Request::is('admin/categories*')) open @endif"><a href=""><i
                        ...
                        <ul class="menu-content">
                            <li class="@if(Route::current()->getName() == 'admin.categories.index') active @endif">
                                ...
                                <router-link :to="'/admin1/categories/index'">show all</router-link>
                            </li>
                            <!--                        @if (auth()->user()->hasPermission('categories_create'))-->
                            <li class="@if(Route::current()->getName() == 'admin.categories.create') active @endif">

                                <router-link :to="'/admin1/categories/create'">add new category</router-link>
                            </li>
                            <!--                        @endif-->
                        </ul>
                    </li>
                    ...
                    <li class="nav-item @if(Request::is('admin/categories*')) open @endif"><a href=""><i
                        ...
                        <ul class="menu-content">
                            <li class="@if(Route::current()->getName() == 'admin.categories.index') active @endif">
                                ...
                                <router-link :to="'/admin1/categories/index'">User Management</router-link>
                            </li>
                            <!--                        @if (auth()->user()->hasPermission('categories_create'))-->
                            <li class="@if(Route::current()->getName() == 'admin.categories.create') active @endif">

                                <router-link :to="'/admin1/setting/global_numbering'">Global Numbering</router-link>
                            </li>
                            <li class="@if(Route::current()->getName() == 'admin.categories.create') active @endif">

                                <router-link :to="'/admin1/setting/add_account'">Add Account</router-link>
                            </li>
                            <li class="@if(Route::current()->getName() == 'admin.categories.create') active @endif">

                                <router-link :to="'/admin1/setting/journal_voucher'">Journal Voucher</router-link>
                            </li>
                            <li class="@if(Route::current()->getName() == 'admin.categories.create') active @endif">

                                <router-link :to="'/admin1/setting/add_role'">Add Role</router-link>
                            </li>
                            <li class="@if(Route::current()->getName() == 'admin.categories.create') active @endif">

                                <router-link :to="'/admin1/setting/add_user'">Add User</router-link>
                            </li>
                            <!--                        @endif-->
                        </ul>
                    </li>
                    ...
                    <!--                                   data-i18n="nav.dash.ecommerce"> @lang('site.show_all') </a>-->
                    <!--                            </li>-->
                    <!--                            &lt;!&ndash;                        @if (auth()->user()->hasPermission('sub_categories_create'))&ndash;&gt;-->
                    ...
                    <!--                                   data-i18n="nav.dash.ecommerce"> @lang('site.show_all') </a>-->
                    <!--                            </li>-->
                    <!--                            &lt;!&ndash;                        @if (auth()->user()->hasPermission('products_create'))&ndash;&gt;-->
                    ...
                    <!--                                   data-i18n="nav.dash.ecommerce"> @lang('site.show_all') </a>-->
                    <!--                            </li>-->
                    <!--                            &lt;!&ndash;                        @if (auth()->user()->hasPermission('tags_create'))&ndash;&gt;-->
                    ...
                    <!--                    <li class="nav-item @if(Route::current()->getName() == 'admin.clients.index') active @endif"><a href=""><i-->
                    <!--                        class="la la-tags"></i>-->
