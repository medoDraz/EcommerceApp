                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="row">
                                        <div
                                            class="col-lg-4 col-sm-12 border-right-blue-grey border-right-lighten-5">
                                            <div class="media d-flex p-2">
                                                ...
                                                <div class="media-body text-right">
                                                    <span class="font-large-2 text-bold-300 info">2</span>
                                                </div>
                                            </div>
                                        ...
                                        <div
                                            ...
                                            <div class="media d-flex p-2">
                                                ...
                                                <div class="media-body text-right">
                                                    <span class="font-large-2 text-bold-300 danger">64</span>
                                                </div>
                                            </div>
                                            <div class="progress mt-1 mb-0" style="height: 7px;">
                                        ...
                                        <div class="col-lg-4 col-sm-12  border-right-lighten-5">
                                            <div class="media d-flex p-2">
                                                <div class="align-self-center">
                                                    ...
                                                    <span
                                                        class="text-muted text-right">@lang('site.categories')</span>
                                                </div>
                                                <div class="media-body text-right">
                                                    <span class="font-large-2 text-bold-300 success">10</span>
                                                </div>
                                            </div>
                                            <div class="progress mt-1 mb-0" style="height: 7px;">
                                        ...
                                        <div
                                            ...
                                            <div class="media d-flex p-2">
                                                <div class="align-self-center">
                                                    ...
                                                    <span
                                                        class="text-muted text-right">@lang('site.sub_categories')</span>
                                                </div>
                                                <div class="media-body text-right">
                                                    <span class="font-large-2 text-bold-300 info">50</span>
                                                </div>
                                            </div>
                                            <div class="progress mt-1 mb-0" style="height: 7px;">
                                                <div class="progress-bar bg-info" role="progressbar"
                                        ...
                                        <div
                                            ...
                                            <div class="media d-flex p-2">
                                                <div class="align-self-center">
                                                    ...
                                                    <span class="text-muted text-right">__('site.products')</span>
                                                </div>
                                                <div class="media-body text-right">
                                                    <span class="font-large-2 text-bold-300 danger">50</span>
                                                </div>
                                            </div>
                                            <div class="progress mt-1 mb-0" style="height: 7px;">
                                                <div class="progress-bar bg-danger" role="progressbar"
                                        ...
                                        <div class="col-lg-4 col-sm-12  border-right-lighten-5">
                                            <div class="media d-flex p-2">
                                                <div class="align-self-center">
                                                    ...
                                                    <span class="text-muted text-right">__('site.tags')</span>
                                                </div>
                                                <div class="media-body text-right">
                                                    <span class="font-large-2 text-bold-300 success">40</span>
                                                </div>
                                            </div>
                                            <div class="progress mt-1 mb-0" style="height: 7px;">
                                                <div class="progress-bar bg-success" role="progressbar"
